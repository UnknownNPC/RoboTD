...
func init() -> bool:
	if Engine.has_singleton("GodotAdMob"):
		...
		_admob_singleton.initWithContentRating(
			is_real, child_directed, is_personalized, max_ad_content_rate
		)
		return true
	return false
...
func connect_signals() -> void:
	...
	_admob_singleton.connect(
		"on_admob_banner_failed_to_load", self, "_on_admob_banner_failed_to_load"
	)
	_admob_singleton.connect(
		"on_interstitial_failed_to_load", self, "_on_interstitial_failed_to_load"
	)
	...
	_admob_singleton.connect(
		"on_rewarded_video_ad_failed_to_load", self, "_on_rewarded_video_ad_failed_to_load"
	)
	_admob_singleton.connect(
		"on_rewarded_interstitial_ad_loaded", self, "_on_rewarded_interstitial_ad_loaded"
	)
	_admob_singleton.connect(
		"on_rewarded_interstitial_ad_opened", self, "_on_rewarded_interstitial_ad_opened"
	)
	_admob_singleton.connect(
		"on_rewarded_interstitial_ad_closed", self, "_on_rewarded_interstitial_ad_closed"
	)
	_admob_singleton.connect(
	...
	_admob_singleton.connect(
		"on_rewarded_interstitial_ad_failed_to_show",
		self,
