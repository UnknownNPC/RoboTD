...
onready var grenadeExposionPlayer = $GrenadeExplosionPlayer
...
func initSmokeGranade(attackPoint, direction, effectValue, effectDurationSec, demoMode):
	.init(attackPoint, direction, demoMode)
